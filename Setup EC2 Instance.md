...
## Step 8 : Setting a Static IP Adress
...
![](images/connect_ec2_5_connected.png)



## Step 8 : Create alarm to stop ec2 instance if inactivity
...
### 8.1 Creating Cloudwatch Alarm

#### 8.1.2 Specify metric and conditions
...
## 8.2 Add a cpu stress in the initialization file of the ec2 instance
